...
#define gimbal_canUpdate() (sendGimbalFeederMsg(GIMBAL_CAN, gimbal.yaw_iq_output, gimbal.pitch_iq_output, NULL, NULL))
...
static THD_FUNCTION(gimbal_init_thread, p)
{
  ...
  while (!chThdShouldTerminateX())
  {
    ...
    case INIT_STATE_LOCK_YAW:
      ...
      break;
    case INIT_STATE_PITCH_YAW:
      _error[GIMBAL_YAW] = (yaw_left_limit + yaw_right_limit) / 2.0f - gimbal.motor[GIMBAL_YAW]._angle;
      break;
    }
